...
class ChangeHandler(UpgradeBase):
    ...
    def _load(self):
        ...
        # _mad_dbrev = 1.7
            ...
            filename = os.path.join(self._maddir, 'madpack',
                                    'changelist_1.7_1.10.yaml')
        # _mad_dbrev = 1.7.1
        elif self._mad_dbrev.split('.') < '1.8'.split('.'):
            filename = os.path.join(self._maddir, 'madpack',
                                    'changelist_1.7.1_1.10.yaml')
        # _mad_dbrev = 1.8
